...
- prompt_breakdown with chat_history AND chat_history_count
...
def create_prompt_breakdown_from_messages(messages: list) -> dict:
    ...
    Includes chat_history_count for conversation tracking.
    ...
    return create_prompt_breakdown(
        ...
        chat_history_count=chat_history_count if chat_history else 0,
    )
...
class ScenarioRunner:
    ...
    async def _execute_turn(
        ...
        try:
            ...
            # Capture TTFT if streaming enabled
